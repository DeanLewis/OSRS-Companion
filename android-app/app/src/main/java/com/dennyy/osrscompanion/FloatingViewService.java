...
import com.dennyy.osrscompanion.models.FloatingViews.FloatingView;
...
import com.dennyy.osrscompanion.viewhandlers.*;
...
import static com.dennyy.osrscompanion.helpers.Constants.SORT_DELIMITER;
...
public class FloatingViewService extends Service implements WindowManagerContainer.ArrangementChangeListener {
    ...
    public static void updateSortOrder() {
        ...
        try {
            for (String sortOrder : preferences.getStringSet(Constants.PREF_FLOATING_VIEWS_SORT_ORDER, new HashSet<String>())) {
    ...
    private FloatingViewPreferences getFloatingViewPreferences(SharedPreferences preferences) {
        ...
        FloatingViewPreferences floatingViewPreferences = new FloatingViewPreferences(startRightSide, alignFloatingViewsLeft, alignmentMargin, inactiveAlpha, MAP.size(), sizeDp);
